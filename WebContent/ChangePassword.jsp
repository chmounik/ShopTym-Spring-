...
<body>
	...
	<div class="header-bottom">
      ...
      <div class="register_account">
		...
		<c:set var="contextPath" value="${pageContext.request.contextPath}" />
    	  <form name="changepassword"  method="post" action="${contextPath}/changepassword/password">

    	    <input type="hidden" name="action" value="changePassword"></input>

    	<div class="col_1_of_2 span_1_of_2">
	${msg}
    <div><label>Email</label><input type="text" id="mail" name="email" value="" ></div>
    <div><label>New Password</label><input type="text" id="pwd" name="password" value=""></div>
    <div><label>Re enter Password</label><input type="text" id="rpwd" name="repassword" value=""></div>
   	</div>
      <div class="col_1_of_2 span_1_of_2">
