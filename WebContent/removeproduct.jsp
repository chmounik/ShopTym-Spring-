...
<body>
	...
	<div class="header-bottom">
      ...
      <div class="register_account">
          ...
          <c:set var="contextPath" value="${pageContext.request.contextPath}" />
    	  <form name="removeproduct" action="${contextPath}/removeproduct/remove" >

    	    <input type="hidden" name="action" value="removeproduct"></input>

    	<div class="col_1_of_2 span_1_of_2">
<p> Please enter your seller id and the product id of the product which you want to delete </p></br>
   	<div><label>Seller ID</label><span>*</span><input type="text" id="sellerid" name="sellerid"  value="" ></div>
    <div><label>Product ID</label><span>*</span><input type="text" id="productid" name="productid" value=""></div>  	
     <div>
