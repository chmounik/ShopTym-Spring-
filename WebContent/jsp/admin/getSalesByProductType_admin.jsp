...
<body>
	...
	<table>
		<form action="${contextPath}/admin/getSalesByProductTypeAdmin" method="GET">
			<tr>
	...
	<table  id="customers">
		...
		<tbody>
			<c:forEach var="saleForProductTypeAdmin"
				items="${salesByProductTypeAdmin}">
				<tr>
					<td>${ saleForProductTypeAdmin.getProductType() }</td>
					<td>${ saleForProductTypeAdmin.getSales() }</td>
				</tr>
			</c:forEach>
		</tbody>
	</table>
