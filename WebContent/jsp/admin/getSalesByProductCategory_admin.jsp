...
<body>
	...
	<table>
		<form action="${contextPath}/admin/getSalesByProductCategoryAdmin" method="GET">
			<tr>
				<td><input type="text" name="productCategory" /></td>
			</tr>
			<tr>
				<td><input type='submit' value='Search Product Category' /></td>
			</tr>
		</form>
	</table>
	<%!ArrayList<SalesByProductCategory> salesByProductCategoryAdmin;%>
	<%
		if (session != null && session.getAttribute("salesByProductCategoryAdmin") != null) {
			salesByProductCategoryAdmin = (ArrayList<SalesByProductCategory>) session
					.getAttribute("salesByProductCategoryAdmin");
		}
	%>
	<table id="customers">
		<thead>
		...
		<tbody>
			<c:forEach var="saleForProductCategoryAdmin"
				items="${salesByProductCategoryAdmin}">
				<tr>
					<td>${ saleForProductCategoryAdmin.getProductCategoryID() }</td>
					<td>${ saleForProductCategoryAdmin.getCategoryName() }</td>
					<td>${ saleForProductCategoryAdmin.getProductType() }</td>
					<td>${ saleForProductCategoryAdmin.getSales() }</td>
				</tr>
			</c:forEach>
		</tbody>
	</table>
