...
<body>
	...
	<h4>
		<a href="${contextPath}/admin/getSalesByProductTypeAdmin?productType=ALL"> Get Sales
			by Product Type </a>
	</h4>
	<h4>
		<a href="${contextPath}/admin/getSalesByProductCategoryAdmin?productCategory=ALL"> Get
