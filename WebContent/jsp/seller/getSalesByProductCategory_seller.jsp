...
<body>
	...
	<br/>
	<table>
		<form action="${contextPath}/seller/getSalesByProductCategorySeller" method="GET">
			<tr>
	...
	<table id="customers">
		...
		<tbody>
			<c:forEach var="saleForProductCategorySeller" items="${salesByProductCategorySeller}">
				<tr>
					<td>${ saleForProductCategorySeller.getProductCategoryID() }</td>
					<td>${ saleForProductCategorySeller.getCategoryName() }</td>
					<td>${ saleForProductCategorySeller.getProductType() }</td>
					<td>${ saleForProductCategorySeller.getSales() }</td>
				</tr>
			</c:forEach>
		</tbody>
	</table>
