...
<body>
	...
	<br/>
	<h4><a href="${contextPath}/seller/getSalesByProductTypeSeller?productType=ALL"> Get Sales by Product Type </a></h4>
	<h4><a href="${contextPath}/seller/getSalesByProductCategorySeller?productCategory=ALL"> Get Sales by Product Category </a></h4>
