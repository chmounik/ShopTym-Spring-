		...
		<div class="wrap">
          ...
          <div class="wrap">
				<div class="col_1_of_login span_1_of_login">
					...
					<p>Welcome to ShopTym. Our motto is 'Save Time, Save Money'. Have a wonderful shopping experience. </p>
					<div class="button1">
					   <a href="${contextPath}/commonUser/register"><input type="submit" name="Submit" value="Continue"></a>
					 </div>
					 <div class="clear"></div>
				</div>
				<div class="col_1_of_login span_1_of_login">
				  ...
				  %>
	           		<h4 class="title">Registered Customers &nbsp; <%=error %></h4>
					 <div class="comments-area">
					 	<c:set var="contextPath" value="${pageContext.request.contextPath}" />
						<form name="login" action="${contextPath}/commonUser/validateUser" method="post">
							...
							<p>
							 ...
							 <p id="login-form-remember">
								<label><a href="${contextPath}/forgotPassword/jsp">Forgot Your Password ? </a></label>
							 </p>
							 <p>
								<input type="submit" id="onsubmit" value="Login">
							</p>
						</form>
					</div>
			      </div>
