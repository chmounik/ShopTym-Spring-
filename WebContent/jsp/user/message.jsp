...
<body>
	...
	<div class="login">
		<div class="wrap">
			...
			<h4>
				<a href="${contextPath}/commonUser/login">Go back to the Login
					page</a>
			</h4>
			<div class="footer">
				<div class="footer-top">
					<div class="wrap">
						<div class="col_1_of_footer-top span_1_of_footer-top">
							<ul class="f_list">
								<li><img src="<c:url value="/resources/f_icon.png"/>"
									alt="" /><span class="delivery">Free delivery on all
										orders over $50*</span></li>
							</ul>
						</div>
						<div class="col_1_of_footer-top span_1_of_footer-top">
							<ul class="f_list">
								<li><img src="<c:url value="/resources/f_icon1.png"/>"
									alt="" /><span class="delivery">Customer Service :<span
										class="orange"> (800)-SHOPTYM (freephone)</span></span></li>
							</ul>
						</div>
						<div class="col_1_of_footer-top span_1_of_footer-top">
							<ul class="f_list">
								<li><img src="<c:url value="/resources/f_icon2.png"/>"
									alt="" /><span class="delivery">Fast delivery and free
										returns</span></li>
							</ul>
						</div>
						<div class="clear"></div>
