			...
			<div class="register_account">
				<div class="wrap">
					...
					<form name="register" method="POST"
						action="${contextPath}/commonUser/registerUser">
						<!--<input type="hidden" name="action" value="register"></input>-->
						<div class="col_1_of_2 span_1_of_2">
							<div>
								<input type="text" name="firstName" value="First Name"
									onfocus="if (this.value == '' || this.value == 'First Name'){this.value = '';}"
									onblur="if (this.value == '') {this.value = 'First Name';}">
							</div>
							<div>
								<input type="text" name="lastName" value="Last Name"
									onfocus="if (this.value == '' || this.value == 'Last Name'){this.value = '';}"
							...
							<div>
								<select name="userType" id="userType" style="max-width: 540px;">
							...
							<br/>
							<div>
								<select name="gender" id="gender" style="max-width: 540px;">
