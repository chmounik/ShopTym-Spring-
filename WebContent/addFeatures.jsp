...
<body>
	...
	<div class="register_account">
		...
		<div class="wrap">
			...
			<form name="addFeatures" method="post" action="${contextPath}/addproduct/addFeatures">
				<div class="col_1_of_2 span_1_of_2">
					<c:forEach var="featureTemplate" items="${featureTemplateList}">
					<div>
						<label>${featureTemplate.getFeatureName()}</label>
						<input type="text" name="${featureTemplate.getFeatureID()}" value="">
					</div>
					</c:forEach>
